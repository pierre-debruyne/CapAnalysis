  ...
  return (
    <div>
      ...
      <Hero
        ...
        imgSrc="/assets/images/hero/hero_ffa.png"
        imgAlt="Forensic financial analysis"
        title={`Forensic financial\n analysis`}
        text={`When things go wrong, we bring clarity,\n evidence, and impact.`}
        imgPosition="object-[65%_35%] md:object-[42%_55%]"
      />

      {/* Mobile */}
      <Hero
        className="block md:hidden"
        imgSrc="/assets/images/hero/hero_ffa_smartphone.jpg"
        imgAlt="Forensic financial analysis"
        title={`Forensic financial\n analysis`}
        text={`When things go wrong, we bring clarity,\n evidence, and impact.`}
      />
      ...
      <div className="flex flex-col lg:flex-row gap-1 w-full pb-1">
        ...
        <div className="bg-[#e9d7c8] w-full py-[35px] lg:py-[65px]">
          <div className="lg:max-w-[417px] lg:w-3/4 px-[35px] md:p-[50px] xl:p-0 mx-auto">
            <h3 className="font-normal font-serif text-[23px] pb-[19px] text-[#2D2D2D]">
      ...
      <div className="bg-dark p-[35px] md:py-[49px] md:px-5 2xl:px-0">
        <div className="max-w-[564px] mx-auto text-[23px] text-white text-center">
          <p className="mb-[15px] font-serif">
      ...
      <div className="bg-white md:py-[60px] p-[35px] md:px-5 2xl:px-0 h-full text-center">
        <div className="max-w-[420px] h-full mx-auto">
          <h2 className="text-[35px] font-serif text-[#2D2D2D] leading-11 pb-[10px] ">
            Pricing
          </h2>
          ...
          <div className="border-y border-[#BAACA9] max-w-[350px] py-[16px] mx-auto">
            <div className="grid grid-cols-2 grid-rows-2 ">
              <span className="uppercase font-semibold font-sans text-[15px text-start text-[#2D2D2D]">
                Partners
              </span>

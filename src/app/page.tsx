...
export default function Home() {
  return (
    <div>
      ...
      {/* Mobile */}
      <Hero className='block md:hidden' imgSrc={"/assets/images/hero/hero_home_smartphone.jpg"} imgAlt='Uncovering the truth behind your wealth management' title={`Uncovering the truth\nbehind your\nwealth management`} text={`Financial bodyguard &\nindependent forensic expert`} />
          ...
          <div className='flex justify-center flex-col items-start md:items-center'>
            ...
            <div className='flex gap-[50px]'>
              ...
              <div className='flex flex-col gap-[13px] justify-end'>
                ...
                <Link href={"/portfolio-monitoring-&-mentorship"} className='shrink-0'>
          ...
          <div className='flex justify-center flex-col items-start md:items-center'>
            ...
            <div className='flex gap-[50px]'>
              ...
              <div className='flex flex-col gap-[13px] justify-end'>
                ...
                <Link href={"/forensic-financial-analysis"} className='shrink-0'>
                  <Button>Learn more</Button>
                </Link>
              </div>
            </div>
      ...
      <div className='bg-dark w-full pb-[35px] py-[35px] px-[35px] md:pb-[37px] md:px-[50px] md:py-[37px]'>
        <div className='flex flex-col lg:flex-row items-center'>
          <div className='relative w-full h-[300px] md:h-[415px]'>
            <Image src='/assets/images/CAPAct_home.png' alt='' fill className='object-contain' priority />
          </div>
          ...
          <div className='w-full flex flex-col items-center'>
            ...
            <Link href={"/capact-innovation-software-performance-investments"} className='shrink-0'>
      ...
      <div className='md:pt-[67px] md:pb-[48px] md:px-[50px] p-[35px]'>
        ...
        <div className='grid xl:grid-cols-3 md:grid-cols-2  auto-rows-auto gap-x-[170px] gap-y-[60px] max-w-max mx-auto items-start'>
          <InfoBlock UppercaseText={"Rebuilds full portfolio history,"} LowercaseText={" enabling analysis of evolving exposures, allocations, and decisions."} />
          ...
          <InfoBlock
            ...
            LowercaseText={
              <>
                It quantifies the <span className='font-semibold'>real impact of fees, retrocessions, and product spreads</span> over time, and determines whether a fund, product, or entire mandate justifies its cost.
              </>
            }
          />
          <InfoBlock UppercaseText={"Constructsprecise, mandate-aligned benchmarks "} LowercaseText={"using currency-specific indices, risk levels, and real allocation logic showing not just how the portfolio performed, but how it should have performed."} />
          <InfoBlock
            UppercaseText={"Audits the execution\n layer"}
            LowercaseText={
              <>
                {" "}
                checking that purchase and redemption prices align with market prices, coupons are paid when due and promised cash flows are honored. <span className='font-semibold'>Flags discrepancies for deeper investigation</span>.
              </>
            }
          />
        </div>

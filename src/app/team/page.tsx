...
export default function Team() {
  return (
    <div>
      {/* Header */}
      <div className='w-full bg-dark mt-[84px] lg:mt-[95px]'>
        <div className='max-w-[1105px] mx-auto flex items-center justify-center text-center'>
      ...
      <div className=' mx-auto pt-[35px] pb-[35px] md:pt-[99px] md:pb-[37px] grid xl:grid-cols-2 gap-x-[100px] gap-y-[35px] md:gap-y-[100px] xl:max-w-[1268px] px-5 xl:px-0'>
        <Profil
          ...
          tel=''
          linkedin='https://www.linkedin.com/in/lital-puller-88526966/'
          mail=''
        />
        ...
        <Profil
          ...
          resume={`Bruno GILLET is a seasoned macroeconomic analyst with three decades of experience across financial analysis, alternative fund management, and trading. He has developed a strong reputation for delivering precise, tailor-made reporting solutions for institutional investors and ultra-high-net-worth individuals (UHNWI). 
          ...
          tel=''
          linkedin='https://www.linkedin.com/in/bruno-gillet-839363178/'
          mail=''
        />
        ...
        <Profil
          ...
          resume={`Imran HUSEIN joined CAPAnalysis in 2017 as an intern while pursuing a degree in Physics at the University of Toronto. He earned his Bachelor’s degree in Physics in 2024.
          ...
          tel=''
          linkedin='https://www.linkedin.com/in/imran-husein-361939178/'
          mail=''
        />
        ...
        <Profil
          ...
          title_job=''
          resume={`Olivier ROCHAIX joined CAPAnalysis in 2020 as Head of Technology. With a strong background in software development and systems architecture, he plays a key role in designing and maintaining the firm’s proprietary tools for portfolio consolidation and investment analysis.
          ...
          tel=''
          linkedin='https://www.linkedin.com/in/olivier-rochaix-0991bb20/'
          mail=''
        />
      </div>
      <Footer />

  ...
  return (
    <div>
      ...
      <div className="bg-dark w-full h-[692px]">
        <div className="max-w-[1105px] h-[692px] bg-brown mx-auto flex items-center justify-center text-center">
          Embed the VIDEO here
        </div>
      </div>

      <div className=" mx-auto pt-[99px] pb-[37px] grid grid-cols-2 gap-x-[100px] gap-y-[100px] max-w-[1268px]">
        <Profil
          imgAlt=""

  ...
  return (
    <div className='w-full lg:h-[73px] bg-dark flex lg:flex-row flex-col justify-center p-5 gap-5 lg:gap-[35px] items-center mx-auto'>
      ...
      <div className='flex gap-2'>
        ...
        <a href='mailto:info@capanalysis.ch' className='hover:underline text-[16px] font-sans font-light text-white'>
          info@capanalysis.ch
        </a>
      </div>
      <Link href={"https://www.linkedin.com/company/capanalysis-sa"}>

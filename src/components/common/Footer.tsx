...
export default function Footer() {
  return (
    <div className="w-full h-[73px] bg-dark flex justify-center gap-[35px] items-center mx-auto">
      <div className="flex gap-2">
        <MapPin className="text-brown" />
        <span className="text-[16px] font-sans font-light text-white">
          118 rue du Rhône - 1204 Geneva - Switzerland
        </span>
      </div>
      <div className="flex gap-2">
        <Smartphone className="text-brown" />
        <Link href="tel:+ 41 (0) 22 321 90 90" className="text-[16px] font-sans font-light text-white hover:underline">
          + 41 (0) 22 321 90 90
        </Link>
      </div>
      <div className="flex gap-2">
        <AtSign className="text-brown" />
        <a

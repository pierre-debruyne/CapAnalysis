    ...
    <header className="bg-dark lg:px-[41px] py-5 lg:pt-7 px-4 lg:pb-[19px]">
      <div className="relative flex items-center justify-between">
        ...
        <nav className="hidden lg:flex absolute z-10 left-1/2 -translate-x-1/2 gap-[32px] xl:gap-[51px]">
          <NavItem
            label="Our Expertise"
            children={[
              { label: "Portfolio Monitoring & Mentorship", href: "/portfolio-monitoring-&-mentorship" },
              { label: "Forensic Financial Analysis", href: "/forensic-financial-analysis" },
              { label: "CAPAct", href: "/capact-innovation-software-performance-investments" },
            ]}
          />
      ...
      >
        ...
        <nav className="px-4 py-3 space-y-2 text-white">
          ...
          <MobileLink href="/forensic-financial-analysis" onClick={() => setOpen(false)}>
            Forensic Financial Analysis
          </MobileLink>
          <MobileLink href="/capact-innovation-software-performance-investments" onClick={() => setOpen(false)}>
            CAPAct
          </MobileLink>

          <div className="h-px bg-white/10 my-3" />

          <MobileLink href="/team" onClick={() => setOpen(false)}>THE TEAM</MobileLink>
          <MobileLink href="/news" onClick={() => setOpen(false)}>NEWS</MobileLink>

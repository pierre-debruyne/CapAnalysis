...
export default function Article({ imgSrc, imgAlt, title, text, text2, posted, hashtag, date}: ArticleProps) {
  return (
    <div className="max-w-[942px] flex border-b border-[#BAACA9] gap-[50px] mx-auto py-[34px]">
      <div>
        <div className="w-[207px] h-[207px] border-beige">
          <Image
            width={207}
            height={207}
            src={imgSrc}
      ...
      <div className="flex flex-col">
        <div className="flex flex-col pb-[13px] gap-[13px]">
          ...
          <div className="flex gap-1">
            <span className="font-sans text-[12px] text-[#BAACA9]">
              Postedon
            </span>
        ...
        <div className="flex flex-col gap-2 pb-[13px]">
          <p className="text-[16px] font-sans font-light text-[#806863]">
            {text}
          </p>
          <p className="text-[16px] font-sans font-light text-[#806863]">
            {text2}

...
export default function Button({ className, children, iconColor }: ButtonProps) {
  ...
  return (
    <button
      className={cn(
        "flex cursor-pointer items-center uppercase gap-2 text-[11px] font-sans font-light px-1 min-h-[25px] border border-[#b7aca9] text-[#806863] transition-colors duration-200",
        className
      )}
    >
